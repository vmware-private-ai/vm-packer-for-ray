...
variable "vsphere_host" {
  type        = string
  description = "The name of the host having access to a datastore on which ISO has been uploaded. (e.g. '10.101.102.158')"
  default     = null
}
...
variable "instant_clone_customization_engine_path" {
  type        = string
  description = "The path on the local machine for deb package. (e.g. '/Users/johndoe/tools/vmware-gosc_1.0.0-2_amd64.deb')"
}

// Ray docker image

variable "common_ray_docker_image" {
  type        = string
